$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                response.forEach((element) => {
                    console.log("user name", element.user.name);
                    ...
                    //put the code above in card and insert post data in card
                    card = "";
                    card +=          ` <div class="bg-white border rounded-sm max-w-md">
    <div class="flex items-center px-4 py-3">
      <img class="h-8 w-8 rounded-full" src="https://picsum.photos/id/1027/150/150"/>
      <div class="ml-3 ">
        <span class="text-sm font-semibold antialiased block leading-tight">8fact</span>
    ...
    <div class="font-semibold text-sm mx-4 mt-2 mb-4">92,372 likes</div>
                    ...
                    containr.append(card);
                });
            },
            error: function (error) {
                console.log("Connection failed !!!, toast-success");
            },
        });
    }
    $("#add").click(function () {
