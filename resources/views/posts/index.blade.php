...
@section('content')
<!-- <div> -->
    <!-- <h1 class="text-3xl font-bold text-cyan-800 underline">
    Hello world!
  </h1> -->
    <h1 class="text-center">Posts</h1>

<div id="containr" class= "flex justify-center items-center flex-col w-full p-6 gap-4 bg-red-500">
...
@foreach($posts as $post)
  <div class="bg-white border rounded-sm max-w-md">
    ...
    <img src="https://picsum.photos/id/244/900/900" class="py-3"/>
...
<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" id="add">Create New Post</button>
